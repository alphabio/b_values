// b_path:: packages/ui/src/ui/input-otp.tsx
...
const InputOTP = React.forwardRef<React.ElementRef<typeof OTPInput>, React.ComponentPropsWithoutRef<typeof OTPInput>>(
  ({ className, ...props }, ref) => (
    <OTPInput ref={ref} containerClassName={cn("flex items-center gap-1", className)} {...props} />
  ),
);
  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative h-9 w-9 text-center text-base border rounded-md transition-all",
